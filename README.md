...
-   [Groq](https://groq.com) is used for fast inference of [OpenAI Whisper](https://github.com/openai/whisper) (for transcription) and [Meta Llama 4](https://llama.meta.com/llama4/) (for generating the text response).
